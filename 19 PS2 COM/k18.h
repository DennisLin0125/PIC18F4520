...
#define Fosc   40000000       /*定義晶振頻率（單位 Hz）*/
...
#define COL4   PORTAbits.RA4   		/* COL4*/
#define TRIS_COL4  DDRAbits.RA4

#define COL5   PORTAbits.RA5   		/* COL5*/
#define TRIS_COL5  DDRAbits.RA5

#define COL6   PORTEbits.RE0   		/* COL6*/
#define TRIS_COL6  DDREbits.RE0

#define COL7   PORTEbits.RE1   		/* COL7*/
#define TRIS_COL7  DDREbits.RE1

#define COL8   PORTEbits.RE2   		/* COL8*/
#define TRIS_COL8  DDREbits.RE2

#define B20   PORTCbits.RC0  		/* B20 */
#define TRIS_B20   DDRCbits.RC0
...
//系統初始化函式
void k18_init(void);/*HL-K18 V3.2主板初始化*/
